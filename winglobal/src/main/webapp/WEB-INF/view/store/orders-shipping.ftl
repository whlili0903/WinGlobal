...
<div class="page-container">
    ...
    <div class="order-info">
        ...
        <div class="total-amount">
       		 合计：<span>${(orders.totalAmount)!}</span>
        </div>
    </div>
      <div class="logis-box">
      		<form id="submitForm" method="post" action="shipping">
	            ...
	            <div>
	                <div class="input">
	                    <div class="select">
	                        	物流公司：
	                        <select name="epCode">
	                        	<#list opts['EP'].children?keys as epKey>
	                        		<option value="${(opts['EP'].children[epKey].code)!}">${(opts['EP'].children[epKey].name)!}</option>
	                        	</#list>
	                        </select>
	                    </div>
	                    <div class="text">
...
<script>
	$(function(){
		$("#submitForm").submit(function(){
			var waybillNo = $("input[name='waybillNo']").val();
