...
<body>
<#include "header2.ftl">
<form action="../memb/orders-seller?menuIndex=22" method="post" id="ListForm">
<div class="body-div">
        	...
        	<div class="content">
		        <div class="order">
		            ...
		            <#if pager.result?size gt 0>
			                ...
			                <table class="item">
			                    ...
			                    <tr class="orders-head">
			                        ...
			                        <td class="align-right">
			                            <a class="order-show" href="../orders/details?ordersId=${(order.id)!}&type=seller"> 查看订单</a>
			                        </td>
			                    </tr>
			                    </thead>
			                    <tbody>
			                    <tr>
			                        ...
			                        <td class="orders-state">
			                        	...
			                        	<#if order.status == 'OT02'>
				                            <div>
				                                <a class="btn-order" type="button" onclick="javascript:location.href = '../orders/shipping-jump?ordersId=${(order.id)!}'" >发货</a>
				                            </div>
			                            </#if>
						...
						<#else>
							<img style="margin-top: 5%;" src="${confs["content.url"]}/img/prom_order.png" />
						</#if>
		            </div>
		        </div>
		        <#if pager.result?size gt 0>
