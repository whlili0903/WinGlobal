        ...
        $(document).ready(function(){
         ...
         <#if succ == true >
        	$(function(){
        			...
        			title: [
       					'注册成功',
        				'background-color:rgb(10, 181, 82); color:#fff;text-align:center;'
    					],
   					 content: '即将跳转到pc首页',
   					 btn: ['确定'],
   					 shadeClose: false,
...
<body>
<div style="width:100%;background-color: #ddd;height:490px;">
<div  style="max-width:480px;margin: auto;">
    <div  style="height: 490px;float: right;background-color: #fff;width:100%;">
        <div class="div-form">
            <div class="div1 div-base"><div class="div8">会员注册</div></div>
            <div class="div2 div-base"> </div>
            <form action="../memb/mobile-register" method="post">
